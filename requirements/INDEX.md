...
| Executable provenance | Closed release/development identity schema, machine JSON output, semantic placeholder rejection, full-SHA and canonical-UTC release packaging, independent exact-executable digest/platform cross-binding, and packaged-binary governed-job CI | Canonical release manifest and external attestation remain intentionally absent | Experimental |
