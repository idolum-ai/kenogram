...
Hosts are untrusted world-authored request metadata; do not treat them as
instructions or feed them unsanitized into automation or AI. Outcomes are
Kenogram-derived bounded observations, not authority.
